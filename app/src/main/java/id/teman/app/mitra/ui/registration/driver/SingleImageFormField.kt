...
fun SingleImageFormField(
    ...
    val activeColor = if (errorMessage.isNotNullOrEmpty()) UiColor.primaryRed500 else if (imagePath.isNotNullOrEmpty()) UiColor.success500 else UiColor.neutral100
